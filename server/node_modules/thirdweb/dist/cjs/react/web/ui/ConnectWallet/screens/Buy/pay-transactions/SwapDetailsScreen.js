...
function SwapTxDetailsTable(props) {
    ...
    if (isTransfer) {
        return ((0, jsx_runtime_1.jsx)("div", { children: fromChainExplorers.explorers?.[0]?.url && sourceTxHash && ((0, jsx_runtime_1.jsxs)(buttons_js_1.ButtonLink, { fullWidth: true, variant: "outline", href: (0, url_js_1.formatExplorerTxUrl)(fromChainExplorers.explorers[0]?.url, sourceTxHash), target: "_blank", gap: "xs", style: {
                    fontSize: index_js_1.fontSize.sm,
                    padding: index_js_1.spacing.sm,
                }, children: ["View on ", fromChainName.name, " Explorer", (0, jsx_runtime_1.jsx)(react_icons_1.ExternalLinkIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm })] })) }));
    }
