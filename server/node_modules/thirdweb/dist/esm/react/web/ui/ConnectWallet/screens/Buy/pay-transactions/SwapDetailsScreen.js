...
export function SwapTxDetailsTable(props) {
    ...
    if (isTransfer) {
        return (_jsx("div", { children: fromChainExplorers.explorers?.[0]?.url && sourceTxHash && (_jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl(fromChainExplorers.explorers[0]?.url, sourceTxHash), target: "_blank", gap: "xs", style: {
