...
export function OnRampScreen(props) {
    ...
    return (_jsxs(Container, { p: "lg", children: [_jsx(ModalHeader, { title: props.title, onBack: props.onBack }), _jsx(Spacer, { y: "xl" }), _jsx(Container, { flex: "column", gap: "xs", center: "y", style: {
                    paddingLeft: spacing.md,
                                ...
                                flex: "1",
                            }, children: _jsx(StepUI, { step: step, client: props.client, payer: props.payer, index: index }) }), index < state.steps.length - 1 && (_jsx(StepConnectorArrow, { active: index === currentStepIndex }))] }, step.action))) }), _jsx(Spacer, { y: "md" }), _jsx(Text, { size: "xs", color: "secondaryText", center: true, style: { padding: `0 ${spacing.xl}` }, children: "Keep this window open until all transactions are complete." }), _jsx(Spacer, { y: "lg" }), _jsx(Container, { flex: "column", gap: "md", children: !state.isDone &&
                    firstStepChainId &&
...
function useOnRampScreenState(props) {
    ...
    const swapQuoteQuery = useBuyWithCryptoQuote(previousStep && currentStep
        ? {
